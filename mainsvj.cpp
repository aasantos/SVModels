...
int main(int argc,const char *argv[])
{
    ...
    SVJ *obj = new SVJ(y,n,sigmav,phi1,sigma1,random,muj,sigmaj,theta);
    ...
    FILE *fp;
    fp = fopen(argv[5],"wa");
    fprintf(fp,"sigmav phi1 sigma1 muj sigmaj theta\n");
    for(int i=0;i<niter;i++){
        ...
        obj->getsigmav(),obj->getphi1(),obj->getsigma1(),obj->getmuj(),obj->getsigmaj(),obj->gettheta());
        }
    delete obj;
    fclose(fp);
    //
